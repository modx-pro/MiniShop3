...
- **Текущий месяц:** [Сентябрь 2026](#сентябрь-2026) (ниже)
- **Предыдущий месяц:** [Август 2026](#август-2026) (ниже)
- **Ещё раньше:** [Июнь 2026](#июнь-2026), [Май 2026](#май-2026), [Апрель 2026](#апрель-2026), [Март 2026](#март-2026), [Февраль 2026](#февраль-2026), [Январь 2026](#январь-2026) (ниже)
- **Архив по месяцам:**
...
**Файлы компонента больше не архивируются при установке (#783).** `core` и `assets` переехали в собственные vehicle, и `.preserved.zip` при обновлении не создаётся: раньше на это уходило три четверти времени установки — 4248 файлов на каждое обновление. Обновление ускорилось с 3,1 до 2,2 секунды на прогретом кэше, на медленных дисках разница больше.

Плата за это — режим **«Восстановить»** при деинсталляции больше не откатывает файлы MiniShop3: архива нет, восстанавливать нечего, поэтому объекты категории вернутся к прежней версии, а файлы будут удалены. Режимы **«Сохранение»** (по умолчанию) и **«Деинсталлировать»** работают как прежде — они и раньше удаляли файлы. Полным откат всё равно не был: Phinx-миграции не откатываются.
