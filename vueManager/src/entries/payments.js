/**
 * Entry point for Payments Grid Vue application (ES Module)
 *
 ...
 * Called when payments tab is activated
 */
export function init(selector = '#ms3-vue-payments') {
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', () => {
    waitForElement('#ms3-vue-payments', () => init())
  })
} else {
  waitForElement('#ms3-vue-payments', () => init())
}
