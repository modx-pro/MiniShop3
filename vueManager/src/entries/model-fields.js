/**
 * Entry point for Model Fields Management widget (ES Module)
 *
...
import ModelFieldsGrid from '../components/ModelFieldsGrid.vue';
 ...
 * Called when Model Fields page loads
 */
export function init(selector = '#ms3-model-fields-vue-wrapper') {
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', () => {
    waitForElement('#ms3-model-fields-vue-wrapper', () => init());
  });
} else {
  waitForElement('#ms3-model-fields-vue-wrapper', () => init());
}
