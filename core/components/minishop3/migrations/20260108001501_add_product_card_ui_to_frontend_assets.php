...
/**
 * Migration: Add ProductCardUI.js to ms3_frontend_assets setting
 *
 * Adds the new ProductCardUI.js file to the frontend assets list.
 * The file should be added before ms3.js since ms3.js initializes all modules.
 */
class AddProductCardUiToFrontendAssets extends AbstractMigration
{
    /**
     * The new JS file to add
     */
    private const NEW_FILE = '[[+jsUrl]]web/ui/ProductCardUI.js';
    ...
    public function down(): void
    {
        ...
        // Remove ProductCardUI.js (check both escaped and unescaped versions)
