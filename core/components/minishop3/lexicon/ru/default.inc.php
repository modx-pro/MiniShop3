...
$_lang['ms3_version_mismatch_warning'] = 'Несовпадение версий MiniShop3: файлы на диске ([[+disk]]) не совпадают с версией установленного пакета ([[+package]]). База данных обновлена, но файлы компонента могли не скопироваться. Проверьте права на запись для core/components/minishop3/ и assets/components/minishop3/.';
...
$_lang['ms3_payment_cash'] = 'Наличные';
...
$_lang['ms3_delivery_self_pickup'] = 'Самовывоз';
$_lang['ms3_email_link_to_order'] = 'Заказ в панели управления →';
