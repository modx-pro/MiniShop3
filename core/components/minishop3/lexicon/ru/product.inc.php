...
$_lang['ms3_product_change_source_confirm'] = 'Вы уверены, что хотите изменить источник файлов? Страница будет перезагружена. Несохранённые изменения на других вкладках товара будут потеряны.';
