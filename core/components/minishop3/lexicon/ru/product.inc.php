...
$_lang['ms3_product_tab_main'] = 'Веб страница';
$_lang['ms3_product_tab_extra'] = 'Свойства товара';
$_lang['ms3_product_tab_seo'] = 'Параметры SEO';
$_lang['ms3_product_tab_gallery'] = 'Галерея';
$_lang['ms3_product_tab_links'] = 'Связи';
$_lang['ms3_product_sections'] = 'Разделы';
...
$_lang['ms3_product_longtitle'] = 'Полное название';
$_lang['ms3_product_description'] = 'Описание';
$_lang['ms3_product_alias'] = 'Псевдоним';
$_lang['ms3_product_introtext'] = 'Вводный текст';
$_lang['ms3_product_content'] = 'Содержимое';
$_lang['ms3_product_template'] = 'Шаблон';
$_lang['ms3_product_richtext'] = 'Редактор';
$_lang['ms3_product_searchable'] = 'Участвует в поиске';
$_lang['ms3_product_cacheable'] = 'Кэшируется';
$_lang['ms3_product_link_attributes'] = 'Атрибуты ссылки';
$_lang['ms3_product_menutitle'] = 'Пункт меню';
$_lang['ms3_product_menuindex'] = 'Позиция в меню';

$_lang['ms3_product_deleted'] = 'Удалён';
$_lang['ms3_product_published'] = 'Опубликован';
$_lang['ms3_product_pub_date'] = 'Дата публикации';
$_lang['ms3_product_unpub_date'] = 'Дата отмены публикации';

$_lang['ms3_product_createdby'] = 'Автор';
$_lang['ms3_product_createdby_help'] = 'Пользователь, который создал ресурс.';
$_lang['ms3_product_createdon'] = 'Дата создания';
$_lang['ms3_product_createdon_help'] = 'Дата создания ресурса.';
$_lang['ms3_product_editedby'] = 'Кто изменил';
$_lang['ms3_product_editedby_help'] = 'Пользователь, который последним изменял ресурс.';
$_lang['ms3_product_editedon'] = 'Дата изменения';
$_lang['ms3_product_editedon_help'] = 'Дата последнего изменения.';
$_lang['ms3_product_deletedon'] = 'Дата удаления';
$_lang['ms3_product_deletedon_help'] = 'Дата удаления ресурса.';
$_lang['ms3_product_deletedby'] = 'Кто удалил';
$_lang['ms3_product_deletedby_help'] = 'Пользователь, который удалил ресурс.';
$_lang['ms3_product_publishedon'] = 'Был опубликован';
$_lang['ms3_product_publishedon_help'] = 'Дата опубликования ресурса.';
...
$_lang['ms3_product_hide_children_in_tree'] = 'Скрыть потомков в дереве';
$_lang['ms3_product_hide_children_in_tree_help'] = 'Эта настройка скроет все дочерние товары и категории в дереве ресурса, независимо от их свойства "show_in_tree".';
$_lang['ms3_product_hide_in_tree'] = 'Скрыть в дереве';
$_lang['ms3_product_show_in_tree'] = 'Показывать в дереве';
$_lang['ms3_product_show_in_tree_help'] = 'По умолчанию, товары магазина не показываются в дереве ресурсов MODX, чтобы не нагружать его. Но вы можете включить вывод некоторых позиций.';
$_lang['ms3_product_syncsite'] = 'Очистить кэш';

$_lang['ms3_product_article'] = 'Артикул';
$_lang['ms3_product_article_help'] = '';
$_lang['ms3_product_price'] = 'Цена';
...
$_lang['ms3_product_remains'] = 'Остаток';
$_lang['ms3_product_remains_help'] = 'Устаревшая подпись. Доступное количество — поле stock товара (ms3_products.stock). Отдельной колонки remains нет.';
$_lang['ms3_product_reserved'] = 'Резерв';
$_lang['ms3_product_reserved_help'] = 'Устаревшая подпись. Состояние резерва хранит сервис инвентаря (ms3_inventory), а не колонка товара.';
$_lang['ms3_product_image'] = 'Изображение';
$_lang['ms3_product_image_help'] = '';
$_lang['ms3_product_thumb'] = 'Превью';
$_lang['ms3_product_thumb_help'] = '';
$_lang['ms3_product_vendor_id'] = 'Производитель';
$_lang['ms3_product_vendor_id_help'] = '';
$_lang['ms3_product_made_in'] = 'Страна';
$_lang['ms3_product_made_in_help'] = '';
$_lang['ms3_product_tags'] = 'Теги';
...
$_lang['ms3_product_popular'] = 'Популярный';
...
$_lang['ms3_product_save'] = 'Сохранить';
$_lang['ms3_product_edit'] = 'Изменить';
$_lang['ms3_product_view'] = 'Просмотр';
$_lang['ms3_product_delete'] = 'Удалить';
$_lang['ms3_product_undelete'] = 'Восстановить';
$_lang['ms3_product_publish'] = 'Включить';
$_lang['ms3_product_unpublish'] = 'Отключить';
$_lang['ms3_product_duplicate'] = 'Копировать';
$_lang['ms3_product_cancel'] = 'Отмена';
$_lang['ms3_product_back'] = 'Назад';
$_lang['ms3_product_prev'] = 'Предыдущий товар';
$_lang['ms3_product_next'] = 'Следующий товар';
$_lang['ms3_product_help'] = 'Помощь';

$_lang['ms3_product_duplicate_confirm'] = 'Вы уверены, что хотите сделать копию этого товара?';
$_lang['ms3_product_delete_desc'] = 'Вы действительно хотите удалить этот товар?';
$_lang['ms3_product_selected_publish'] = 'Включить выбранные товары';
...
$_lang['ms3_gallery_file_description'] = 'Описание';
$_lang['ms3_gallery_file_size'] = 'Размер';
$_lang['ms3_gallery_file_createdon'] = 'Дата создания';
