...
$_lang['setting_ms3_category_grid_fields_desc'] = 'Список видимых полей таблицы с товарами категории, через запятую.';
...
$_lang['setting_ms3_add_icon_category'] = 'Иконка добавления категории';
$_lang['setting_ms3_add_icon_category_desc'] = 'Иконка на кнопке добавления категории на странице категории';
$_lang['setting_ms3_add_icon_product'] = 'Иконка добавления товара';
$_lang['setting_ms3_add_icon_product_desc'] = 'Иконка на кнопке добавления товара на странице категории';
...
$_lang['setting_ms3_date_format_desc'] = 'Укажите формат дат MiniShop3, используя синтаксис php функции strftime(). По умолчанию формат "%d.%m.%y %H:%M".';
...
$_lang['setting_ms3_frontend_css'] = 'Стили фронтенда';
$_lang['setting_ms3_frontend_css_desc'] = 'Путь к файлу со стилями магазина. Если вы хотите использовать собственные стили - укажите путь к ним здесь, или очистите параметр и загрузите их вручную через шаблон сайта.';
$_lang['setting_ms3_frontend_js'] = 'Скрипты фронтенда';
$_lang['setting_ms3_frontend_js_desc'] = 'Путь к файлу со скриптами магазина. Если вы хотите использовать собственные скрипты - укажите путь к ним здесь, или очистите параметр и загрузите их вручную через шаблон сайта.';

$_lang['setting_ms3_frontend_message_css'] = 'Стили библиотеки уведомлений';
$_lang['setting_ms3_frontend_message_css_desc'] = "Путь к CSS файлу вашей библиотеки уведомлений. По умолчанию к jgrowl. <br>
...
$_lang['setting_ms3_frontend_message_js'] = 'Скрипты библиотеки уведомлений';
$_lang['setting_ms3_frontend_message_js_desc'] = "Путь к JS файлу вашей библиотеки уведомлений. По умолчанию к jgrowl. <br>
...
$_lang['setting_ms3_frontend_message_js_settings'] = 'Настройки библиотеки уведомлений';
$_lang['setting_ms3_frontend_message_js_settings_desc'] = "Путь к файлу с реализацией шаблона уведомлений на основе вашей библиотеки. <br>
...
$_lang['setting_ms3_register_frontend'] = 'Добавлять js и css из комплекта ms2 файлы в DOM дерево';
$_lang['setting_ms3_register_frontend_desc'] = 'Разрешить добавление в DOM дерево ссылок на js и css файлы из комплекта ms2';

$_lang['setting_ms3_order_format_num'] = 'Формат нумерации заказа';
$_lang['setting_ms3_order_format_num_desc'] = 'Формат нумерации заказа. Доступные значения в формате PHP strftime()';
