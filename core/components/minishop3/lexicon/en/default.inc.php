...
$_lang['ms3_orders_desc'] = 'Customer management';
...
$_lang['ms3_modxprovuecore_required'] = 'ModxProVueCore package is required for MiniShop3. Please install it via Package Manager.';
